...
opts =                          Options ('diva.conf');

opts.Add                        (BoolOption ('GDVDEBUG', 'Enable extra Gdv debug messages', 0));
opts.Add                        (BoolOption ('MCSDEBUG', 'Enable debugging information generated by mcs', 0));
...
opts.Add                        (PathOption ('LOCALEDIR', 'System locale installation path', '$SHAREDIR/locale'));

#opts.Add                        (PathOption ('PREFIX', 'System base prefix path', '/usr', PathOption.PathIsDirCreate));
#opts.Add                        (PathOption ('LIBDIR', 'System library path', '$PREFIX/lib', PathOption.PathIsDirCreate));
#opts.Add                        (PathOption ('BINDIR', 'System executable path', '$PREFIX/bin', PathOption.PathIsDirCreate));
#opts.Add                        (PathOption ('SHAREDIR', 'System shared data path', '$PREFIX/share', PathOption.PathIsDirCreate));
#opts.Add                        (PathOption ('DESTDIR', 'System base installation path', '/', PathOption.PathIsDirCreate));
#opts.Add                        (PathOption ('LOCALEDIR', 'System locale installation path', '$SHAREDIR/locale', PathOption.PathIsDirCreate));
