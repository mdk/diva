...
################################################################################
#                                                                              #
# Use this script to run Diva uninstalled with TRACING. You can lunch it from  #
...
exec mono --debug --trace="N:Diva.Exe,N:Diva.Core,N:Diva.Commands,N:Diva.Editor.Model,N:Diva.Editor.Gui,N:Diva.Widgets,N:Diva.MainMenu" "$BASEDIR/../src/Diva.Exe/diva.exe" "$@"
